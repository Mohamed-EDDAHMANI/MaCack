  ...
  return (
    ...
    >
      <View className="flex-1">
        {/* Bottom decoration - linear gradient (bottom → top) */}
        <LinearGradient
          ...
          <View className="max-w-md mx-auto w-full pt-16">
            ...
            <View className="space-y-4">
              <View className="mb-4">
                ...
                <View className="flex-row items-center h-14 rounded-xl border px-4 bg-white" style={{ borderColor: SLATE_200 }}>
            ...
            <View className="mb-8 px-2">
              <View className="flex-row flex-wrap items-center justify-center">
                ...
                <Pressable onPress={() => router.push("/(tabs)/register")} hitSlop={8}>
