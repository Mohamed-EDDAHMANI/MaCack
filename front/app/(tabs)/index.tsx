...
const FEATURED_CARD_WIDTH = 288; // w-72 = 18rem = 288px
const FEATURED_CARD_HEIGHT = 176; // h-44 = 11rem = 176px
const CHIP_GAP = 12;
const CARD_IMAGE_HEIGHT = 256; // h-64
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      <View style={styles.header}>
        ...
        <Pressable style={[styles.iconBtn, styles.avatarBtn]} hitSlop={12}>
            ...
            <View key={i} style={styles.trendingCard}>
              <View style={styles.trendingImageWrap}>
                ...
                <Pressable
                  style={[
                    styles.heartBtn,
                    card.isFav && styles.heartBtnActive,
                  ]}
                >
                  <MaterialIcons
                    name="favorite"
                    size={22}
                    color={card.isFav ? PRIMARY : PRIMARY + "66"}
                  />
                </Pressable>
              </View>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingTop: 16,
    paddingBottom: 8,
    backgroundColor: BACKGROUND_LIGHT + "cc",
    borderBottomWidth: 1,
